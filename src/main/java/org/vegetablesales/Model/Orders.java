...
//	private BillingDetails billing; 
	...
	public Orders(Integer orderId, List<VegetableDTO> vegetableList, Double totalAmount, String orderStatus, Customer customer, LocalDate orderDate) {
		super();
...
//	}
	...
	public String toString() {
		return "Orders [orderId=" + orderId + ", vegetableList=" + vegetableList + ", totalAmount=" + totalAmount
				+ ", orderStatus=" + orderStatus +  ", customer=" + customer + ", orderDate="
				+ orderDate + "]";
	}
