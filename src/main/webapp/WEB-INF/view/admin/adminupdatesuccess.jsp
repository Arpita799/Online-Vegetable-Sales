...
<body>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="updateadmin" modelAttribute="admin" method="get">
         
        <div class="alert alert-success">Admin record updated successfully</div>
  
         <div class="form-group">
            <button type="submit" class="btn btn-primary">Update more</button>
          </div>
        </form:form>
     </div>
    <!-- Banner Begin -->
