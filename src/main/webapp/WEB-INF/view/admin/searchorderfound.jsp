...
<body>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="#">Orders</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="../admin/searchorder">Search Order</a></li>
                                    <li><a href="../admin/dateorder">Search Order by Date</a></li>
                                    <li><a href="../admin/custorder">Search Order by Customer</a></li>
                                    <li><a href="../admin/allorders">View All Orders</a></li>
                                </ul>
                            </li>
                            <li><a href="#">Feedback</a>
                                <ul class="header__menu__dropdown">
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="searchorder" modelAttribute="order" method="get">
         <div class="form-group">
           <label for="orderId">Order Id :</label>
           <input disabled path="orderId" value="${order.orderId}" class="form-control" id="orderId"/>
         </div>

         <div class="form-group">
            <label for="customerId">Customer Id :</label>
            <input disabled path="customer" value="${order.customer.customerId}" class="form-control" id="customerId"/>
          </div>

          <div class="form-group">
            <label for="orderDate">Date :</label>
            <input disabled path="orderDate" value="${order.orderDate}" class="form-control" id="orderDate"/>
          </div>

          <div class="form-group">
            <label for="orderStatus">Status :</label>
            <input disabled path="orderStatus" value="${order.orderStatus}" class="form-control" id="orderStatus"/>
          </div>
          
          <div class="form-group">
            <label for="totalAmount">Total Amount :</label>
            <input disabled path="totalAmount" value="${order.totalAmount}" class="form-control" id="totalAmount"/>
          </div>
        ...
        <%
            ...
            out.println("<td><a href=\"http://localhost:7000/admin/viewveg?orderId=" +order.getOrderId()+ "\"><button>View Vegetables</button></a></td>");
            out.println("<td><a href=\"http://localhost:7000/admin/updatestatus?orderId=" +order.getOrderId()+ "\"><button>Update Order Status</button></a></td>");
        %>
     </div>
