...
<body>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="dateorder" modelAttribute="order" method="post">
         <div class="form-group">
           <label for="orderDate">Customer ID :</label>
           <form:input type="date" path="orderDate" class="form-control" id="orderDate"/>
         </div>
         <div class="form-group">
