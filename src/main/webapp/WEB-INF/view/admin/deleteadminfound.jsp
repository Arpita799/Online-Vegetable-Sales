...
<body>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="deleteadminprocess" modelAttribute="admin" method="post">
         ...
         <div class="form-group">
            ...
            <input text="name" disabled value="${admin.name}" class="form-control" id="name"/>
          </div>

          <div class="form-group">
            <label for="contactNumber">Contact Number :</label>
            <input text="contactNumber" disabled value="${admin.contactNumber}" class="form-control" id="contactNumber"/>
          </div>

          <div class="form-group">
            <label for="emailid">Email ID :</label>
            <input text="emailid" disabled value="${admin.emailid}" class="form-control" id="emailid"/>
          </div>
          <div class="form-group">
