<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    import="java.util.*,org.vegetablesales.Model.*,org.vegetablesales.Service.*"%>
...
<body>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="updateorderprocess" modelAttribute="order" method="post">
         <div class="form-group">
           <label for="orderId"></label>
           <form:hidden path="orderId" value="${order.orderId}" class="form-control" id="orderId"/>
         </div>
         
         <div class="form-group">
            <label for="customerId">Customer Id :</label>
            <form:input path="customer" value="${order.customer.customerId}" class="form-control" id="customerId"/>
          </div>
          ...
          <div class="form-group">
            ...
            <form:input path="orderStatus" value="${order.orderStatus}" class="form-control" id="orderStatus"/>
          </div>
          
          <div class="form-group">
            <label for="totalAmount">Total Amount :</label>
            <form:input path="totalAmount" value="${order.totalAmount}" class="form-control" id="totalAmount"/>
          </div>
