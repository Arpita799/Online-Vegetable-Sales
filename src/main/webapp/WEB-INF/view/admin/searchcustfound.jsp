...
<body>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <h5>Customer Id: ${cust.customerId}</h5>
        <h5>Customer Name: ${cust.name}</h5>
        <h5>Customer Mobile No.: ${cust.mobileNumber}</h5>
        <h5>Customer Email: ${cust.email}</h5>
        <h5>Flat no.: ${cust.address.flatNo}</h5>
        <h5>Bulding Name: ${cust.address.buildingName}</h5>
        <h5>Area: ${cust.address.area}</h5>
        <h5>City: ${cust.address.city}</h5>
        <h5>State : ${cust.address.state}</h5>
        <h5>Pin Code : ${cust.address.pincode}</h5>
     </div>
    <!-- Banner Begin -->
