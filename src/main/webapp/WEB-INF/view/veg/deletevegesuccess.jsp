...
<body>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="deletevege" modelAttribute="veg" method="get">
         
        <div class="alert alert-success">Vegetable record deleted successfully</div>
  
         <div class="form-group">
            <button type="submit" class="btn btn-primary">Delete more</button>
          </div>
        </form:form>
     </div>
    <!-- Banner Begin -->
