...
<body>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="#">Customers</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./admin/searchcust">Search Customer</a></li>
                                    <li><a href="./admin/viewcust">View All Customers</a></li>
                                </ul>
                            </li>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="deletevegeprocess" modelAttribute="veg" method="post">
         <div class="form-group">
           <label for="vegId"></label>
           <form:hidden path="vegId" value="${veg.vegId}" class="form-control" id="vegId"/>
         </div>

         <div class="form-group">
            <label for="name">Vegetable Name :</label>
            <input text="name" disabled value="${veg.name}" class="form-control" id="name"/>
          </div>

          <div class="form-group">
            <label for="price">Price :</label>
            <input text="price" disabled value="${veg.price}" class="form-control" id="price"/>
          </div>

          <div class="form-group">
            <label for="type">Type :</label>
            <input text="type" disabled value="${veg.type}" class="form-control" id="type"/>
          </div>

          <div class="form-group">
            <label for="quantity">Quantity :</label>
            <input text="quantity" disabled value="${veg.quantity}" class="form-control" id="quantity"/>
          </div>
