...
<body>
    ...
    <!-- Header Section End -->
    <div class="container" >
        <form:form action="updatevegeprocess" modelAttribute="veg" method="post">
         ...
         <div class="form-group">
            ...
            <form:input path="name" value="${vege.name}" class="form-control" id="name"/>
          </div>

          <div class="form-group">
            <label for="price">Price :</label>
            <form:input path="price" value="${veg.price}" class="form-control" id="price"/>
          </div>

          <div class="form-group">
            <label for="type">Type :</label>
            <form:input path="type" value="${veg.type}" class="form-control" id="type"/>
          </div>

          <div class="form-group">
            <label for="quantity">Quantity :</label>
            <form:input path="quantity" value="${veg.quantity}" class="form-control" id="quantity"/>
          </div>
